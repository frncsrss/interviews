...
public class SuffixArray2Test {
  ...
  public void test_index() {
    SuffixArray2 sa = new SuffixArray2("babaaaabcbabaaaaa0");
  ...
  @Test
  public void test_lcp() {
    SuffixArray2 sa = new SuffixArray2("babaaaabcbabaaaaa0");
    Assert.assertEquals(0, sa.lcp(0));
    Assert.assertEquals(1, sa.lcp(1));
    Assert.assertEquals(2, sa.lcp(2));
    Assert.assertEquals(3, sa.lcp(3));
    Assert.assertEquals(4, sa.lcp(4));
    Assert.assertEquals(4, sa.lcp(5));
    Assert.assertEquals(3, sa.lcp(6));
    Assert.assertEquals(2, sa.lcp(7));
    Assert.assertEquals(1, sa.lcp(8));
    Assert.assertEquals(6, sa.lcp(9));
    Assert.assertEquals(2, sa.lcp(10));
    Assert.assertEquals(0, sa.lcp(11));
    Assert.assertEquals(5, sa.lcp(12));
    Assert.assertEquals(2, sa.lcp(13));
    Assert.assertEquals(7, sa.lcp(14));
    Assert.assertEquals(1, sa.lcp(15));
    Assert.assertEquals(0, sa.lcp(16));
  }
}
